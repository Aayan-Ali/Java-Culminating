...
public class Player_2 extends Entity{
    KeyHandler keyH;

    public Player_2(GamePanel gp, main.KeyHandler keyH) {
    ...
    public void getPlayerImage() {
        try {
            ...
            up3 = ImageIO.read(getClass().getResourceAsStream("/player/boy2_up_3.png"));
            ...
            down3 = ImageIO.read(getClass().getResourceAsStream("/player/boy2_down_3.png"));
